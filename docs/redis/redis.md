...
DECR counter            # 숫자 감소
APPEND key "!!!"        # key 값에 문자열 추가 (Hello Redis!!!)ff
DEL key                 # key 삭제
```

- 실행 결과 예시

![alt text](assets/string-command.png)
...
![alt text](assets/list-command.png)
...
![alt text](assets/set-command.png)
...
![alt text](assets/sortedset-command.png)
...
![alt text](assets/hash-command.png)
